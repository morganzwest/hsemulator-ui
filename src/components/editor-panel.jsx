      ...
      <>
        <div className='flex h-full items-center justify-center'>
          <div className='flex max-w-sm flex-col items-center text-center'>
            ...
            {/* Text */}
            <h3 className='text-sm font-medium'>No action selected</h3>
            <p className='mt-1 text-sm text-muted-foreground'>
              Select an existing action to view its files, or create a new one
              to get started.
            </p>
...
async function handleSaveTemplate() {
      ...
      <div className='flex items-center justify-between border-b pb-2'>
        ...
        <div className='flex items-center gap-2'>
          <Tooltip>
            ...
            <TooltipContent>
              Swap the output view orientation to{' '}
    ...
    >
      <Star
        className={`
          ...
          ${templateSaved ? 'scale-110 text-blue-400' : ''}
          ${templateSaving ? 'animate-pulse' : ''}
        `}
  ...
  <TooltipContent>
    {templateSaved ? 'Template saved' : 'Save as a template'}
  </TooltipContent>
</Tooltip>
